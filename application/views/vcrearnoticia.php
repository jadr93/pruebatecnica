...
<div class="container containernews">
    ...
    <textarea rows="15" id="contenido" name="contenido" value="password" style="text-align:left" required></textarea>
    <div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="privada">
  <label class="form-check-label" for="flexCheckDefault">
    Privada
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="" id="publicada" >
...
$('.confirmar').click(function(){
    ...
    console.log(privada);
    $.ajax({
        url:"<?= base_url('Cadmin/confirmarCreacion'); ?>",
        method:'post',
        data:{titulo, contenido, privada, publicada},
